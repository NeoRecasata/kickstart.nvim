...
Kickstart Guide:
  ...
  I have left several `:help X` comments throughout the init.lua
    These are hints about where to find more information about the releant settings,
...
require('lazy').setup({
  ...
  -- to add a local plugin `dir = "[PATH_TO_PLUGIN]"
  ...
  },
  {
    ...
    config = function()
      vim.keymap.set('n', '<leader>T', ':NvimTreeToggle<CR>', { desc = 'Toggle Nvim [T]ree', silent = true })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'yaml', 'python', 'dart' },
